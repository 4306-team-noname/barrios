# Generated by Django 4.2.7 on 2023-11-19 23:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eva_accuracy', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datedim', models.DateField()),
                ('nationality_category', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affected_consumable', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adjusted_o2_kg', data.models.CustomFields.EmptyStringToNoneFloatField()),
                ('adjusted_n2_kg', data.models.CustomFields.EmptyStringToNoneFloatField()),
                ('resupply_o2_kg', data.models.CustomFields.EmptyStringToNoneFloatField(blank=True, null=True)),
                ('resupply_n2_kg', data.models.CustomFields.EmptyStringToNoneFloatField(blank=True, null=True)),
                ('resupply_air_kg', data.models.CustomFields.EmptyStringToNoneFloatField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('date', models.DateField(primary_key=True, serialize=False)),
                ('corrected_potable_l', data.models.CustomFields.EmptyStringToNoneFloatField()),
                ('corrected_technical_l', data.models.CustomFields.EmptyStringToNoneFloatField()),
                ('corrected_total_l', data.models.CustomFields.EmptyStringToNoneFloatField()),
                ('resupply_potable_l', data.models.CustomFields.EmptyStringToNoneFloatField(blank=True, null=True)),
                ('resupply_technical_l', data.models.CustomFields.EmptyStringToNoneFloatField(blank=True, null=True)),
                ('corrected_predicted_l', data.models.CustomFields.EmptyStringToNoneFloatField()),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('threshold_category', models.CharField(blank=True, max_length=255, null=True)),
                ('threshold_value', models.FloatField()),
                ('threshold_owner', models.CharField(blank=True, max_length=255, null=True)),
                ('units', models.CharField(blank=True, max_length=255, null=True)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='data.category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ims_id', data.models.CustomFields.EmptyStringToNoneIntegerField(null=True)),
                ('id_parent', data.models.CustomFields.EmptyStringToNoneIntegerField(null=True)),
                ('id_path', models.CharField(max_length=200)),
                ('tree_depth', data.models.CustomFields.EmptyStringToNoneIntegerField(null=True)),
                ...
                ('original_ip_owner', models.CharField(blank=True, max_length=200, null=True)),
                ('current_ip_owner', models.CharField(blank=True, max_length=200, null=True)),
                ('operational_nomenclature', models.CharField(blank=True, max_length=200, null=True)),
                ('russian_name', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('quantity', data.models.CustomFields.EmptyStringToNoneIntegerField(null=True)),
                ('width', data.models.CustomFields.EmptyStringToNoneFloatField(blank=True, null=True)),
                ('height', data.models.CustomFields.EmptyStringToNoneFloatField(blank=True, null=True)),
                ('length', data.models.CustomFields.EmptyStringToNoneFloatField(blank=True, null=True)),
                ('diameter', data.models.CustomFields.EmptyStringToNoneFloatField(blank=True, null=True)),
                ('calculated_volume', data.models.CustomFields.EmptyStringToNoneFloatField(blank=True, null=True)),
                ('stwg_ovrrd_vol', data.models.CustomFields.EmptyStringToNoneFloatField(blank=True, null=True)),
                ('children_volume', data.models.CustomFields.EmptyStringToNoneFloatField(blank=True, null=True)),
                ('stwg_ovrrd_chldrn_vol', data.models.CustomFields.EmptyStringToNoneFloatField(blank=True, null=True)),
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='data.category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unique_cat_mod_id', models.CharField(blank=True, max_length=255, null=True)),
                ('category', models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, to='data.category')),
            ],
            options={
