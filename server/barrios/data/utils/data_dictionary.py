data_dictionary = {
    ...
    "iss_flight_plan_crew": {
        ...
        "columns": ["datedim", "nationality_category", "crew_count"],
    },
    "iss_flight_plan_crew_nationality_lookup": {
        "model_name": "IssFlightPlanCrewNationalityLookup",
        "columns": ["nationality", "is_usos_crew", "is_rsa_crew"],
    },
    "rates_definition": {
    ...
    "tank_capacity_definition": {
        ...
        "columns": ["tank_category", "tank_capacity", "units"],
    },
    ...
    "stored_items_only_inventory_mgmt_system_consumables": {
        "model_name": "StoredItemsOnlyInventoryMgmtSystemConsumables",
        "columns": [
            "datedim",
            "id",
            "id_parent",
