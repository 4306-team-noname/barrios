...
def create_consumable_optimization_chart(optimization_obj, with_title=True):
    consumable_name = optimization_obj["consumable_name"]
    df = optimization_obj["df"]
    threshold_value = optimization_obj["threshold_value"]
    threshold_plus_value = optimization_obj["threshold_plus_value"]
    critical_value = optimization_obj["critical_value"]
    min_value = optimization_obj["min_value"]
    max_value = optimization_obj["max_value"]
